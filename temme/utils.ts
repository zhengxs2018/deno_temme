import type { cheerio } from '../deps.ts'
import type {
  Section,
  Qualifier,
  AttributeQualifier,
...
export function isCheerioStatic(
  arg: cheerio.CheerioAPI | cheerio.Element,
): arg is cheerio.CheerioAPI {
  return typeof (<cheerio.CheerioAPI>arg).root === 'function'
}

export function isAttributeQualifier(
  qualifier: Qualifier,
): qualifier is AttributeQualifier {
